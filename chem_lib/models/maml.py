...
from learn2learn.utils import clone_module, update_module, detach_module
...
class MAML(BaseLearner):
	...
	**Example**
	...
	def adapt(
		...
		* **allow_nograd** (bool, *optional*, default=None) - Whether to allow adaptation with
		...
		if allow_nograd:
			...
			print("allow_nograd")# Compute relevant gradients
		...
		# Update the module
		#print(gradients)
		self.module = self.maml_update(self.module, self.lr, gradients, adaptable_weights, anil)
	...
	def maml_update(self,model, lr, grads=None, adaptable_weights=None, anil=False):
		"""
		[[Source]](https://github.com/learnables/learn2learn/blob/master/learn2learn/algorithms/maml.py)
