    ...
    def process(self):
        ...
        if self.dataset == 'tox21':
            ...
            for i in range(len(smiles_list)):
                ...
                ##
                #print("datafragmentation")
                #data.frag = list(BRICS.BRICSDecompose(rdkit_mol))
                ##
...
def _load_tox21_dataset(input_path):
    ...
    labels[len(binary_list[0]):len(binary_list[0])+len(binary_list[1]),0] = 1 
    labels[len(binary_list[0])+len(binary_list[1]):,0] = -1
